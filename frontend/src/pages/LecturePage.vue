        ...
        <div class="sidebar-container">
            <div class="aside_title">
                ...
                <button @click="asideToggle()" type="button" class="aside_close_button" id="aside_close_button">
                    <svg width="15" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="times" role="img"
            ...
            <div class="aside_lecture_container">
                <div class="aside_lecture_info">
                    <div>
                        <p class="aside_lecture_title">HTML/CSS All-in-one : 기초부터 Bootstrap, SASS, 고급 animation 까지</p>
                        <p class="aside_lecture_complete">진도율 : 0강 / 1강 (0.00%)</p>
                        <p class="aside_lecture_complete">시간: 0분 / 10분</p>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>HTML/CSS All-in-one : 기초부터 Bootstrap, SASS, 고급 animation 까지</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="breadcrumbs">
                            <ul>
                                <li @click="asideToggle()" id="aside_open_button"><i class="fa fa-bars menu_mm" aria-hidden="true"></i> 목차</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="blog_content">
                        <div class="blog_title">강의1</div>

                        <div class="blog_post_video_container">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/Av9UFzl_wis?si=gmT7PE_vXCZsF38G" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
...
#hideshow_course_pursue_panel.hide span:after, #hideshow_course_pursue_panel.hide span:before {
    top: 14px;
